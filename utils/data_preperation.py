...
train_val_ratio = 0.7
data_folder = "./data/"
train_out_path = os.path.join(data_folder, "train_video_youtube.csv")
val_out_path = os.path.join(data_folder, "val_video_youtube.csv")
...
def balance_data(csv_path):
    ...
    pos_data_selected = pos_data[:target_count]
    neg_data_selected = neg_data[:target_count]
...
def main():
    ...
    train_data_selected = balance_data("./data/train_image.csv")
    val_data_selected = balance_data("./data/val_image.csv")
